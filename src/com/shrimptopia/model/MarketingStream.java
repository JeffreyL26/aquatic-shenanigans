...
public enum MarketingStream {
    ...
    RADIO    ("Lokalradio-Spot", "'Frische Shrimps - jetzt auch ohne Meer!' Läuft zwischen Blasmusik und Stau-Meldung.",
              30, 14, "mkt.radio"),
    SOCIAL   ("Social-Media-Kanal", "Mira postet Becken-Content. Die Kommentare sind zu 90% 'warum?'. Es funktioniert.",
              60, 26, "mkt.social"),
    TUBE     ("ShrimpTube-Kanal", "Eigener Video-Kanal aus dem Viral-Hit. Reichweite: beängstigend.",
              120, 55, "mkt.tube"),
